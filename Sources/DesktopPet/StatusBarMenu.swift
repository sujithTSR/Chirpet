...
public class StatusBarMenuController: NSObject {
    ...
    public func updateMenu() {
        ...
        // Header / Status Info
        let headerItem = NSMenuItem(title: "🐾 Desktop Pet (\(viewModel.character.rawValue))", action: nil, keyEquivalent: "")
        ...
        // Quit item
        let quitItem = NSMenuItem(title: "Quit Desktop Pet", action: #selector(quitApp), keyEquivalent: "q")
